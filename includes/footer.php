...
<!-- SweetAlert2 para alertas visuais -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

<!-- Scripts principais AdminLTE 3 -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/admin-lte@3.2/dist/js/adminlte.min.js"></script>

<!-- Scripts específicos do sistema SIGEP -->
<script src="assets/js/theme-manager.js?v=<?= time() ?>"></script>
<script src="assets/js/header.js?v=<?= time() ?>"></script>
<script src="assets/js/sidebar.js"></script>
<script src="assets/js/footer.js"></script>

<!-- Serviços SIGEP (auto-executáveis) -->
<script src="modulos/servicos/bancos_br_febraban/assets/js/bancos_br_febraban.js?v=<?= time() ?>"></script>
